...
// const uni = graduates.filter(word => word.university.)
// console.log(uni);
...
*/
const lowerCase = zooAnimals.map(word => word.animal_name.toLowerCase()); 
...
lowerPopulation.push(zooAnimals.filter(element => element.population < 5)); 
